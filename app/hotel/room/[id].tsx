  ...
  return (
    ...
    >
      ...
      <View className="px-5 mt-6 mb-5">
        <Text className="text-yellow-600 text-xs font-bold tracking-[3px] uppercase mb-2">
          Rooms
        </Text>
            ...
            <View className="p-5">
              ...
              <View className="flex-row flex-wrap gap-4 mb-4">
                <View className="flex-row items-center gap-1">
                  ...
                  <Text className="text-neutral-300 text-xs">{item.size}</Text>
                </View>
                ...
                <View className="flex-row items-center gap-1">
                  ...
                  <Text className="text-neutral-300 text-xs">{item.beds}</Text>
                </View>
